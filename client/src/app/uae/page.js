...
export const metadata = {
  ...
  description: 'أفضل حل شات بوت ذكي يفهم اللهجة الإماراتية. زود مبيعاتك وارضي عملاءك بخدمة ذكية 24 ساعة.',
  keywords: 'شات بوت إماراتي، ذكاء اصطناعي، خدمة عملاء، اللهجة الإماراتية، واتساب بوت',
  openGraph: {
