            ...
            >
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 text-lg font-medium">
                  نحن هنا لمساعدتك. سواء كان لديك استفسار، اقتراح، أو مشكلة،
                ...
                <div className="flex items-start gap-6 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                      للحصول على رد أسرع ومتابعة دقيقة لحالة طلبك، نوصي بفتح
                      تذكرة دعم فني مباشرة من لوحة التحكم.
                    </p>
            ...
            >
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="w-full h-14 text-lg font-bold bg-brand-600 hover:bg-brand-700 text-white shadow-lg shadow-brand-500/20 transition-all hover:scale-[1.02]"
                    disabled={status === 'loading' || !captchaValid}
                  >
