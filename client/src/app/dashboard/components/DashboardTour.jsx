...
const TOUR_STEPS = [
  {
    ...
    content: '👋 مرحباً بك في لوحة التحكم! دعنا نأخذك في جولة سريعة للتعرف على المميزات الأساسية.',
    placement: 'center',
    disableBeacon: true,
  ...
  },
  {
    ...
    content: '📊 هنا تجد ملخص إحصائياتك: عدد المحادثات، معدل الرضا، وأداء البوت.',
    placement: 'bottom'
  },
  {
  ...
  {
    target: 'body',
    content: '🎉 رائع! أنت الآن جاهز للبدء. يمكنك دائماً إعادة الجولة من قائمة المساعدة.',
    placement: 'center'
  }
]
  ...
  const handleJoyrideCallback = (data) => {
    ...
    if ([EVENTS.STEP_AFTER, EVENTS.TARGET_NOT_FOUND].includes(type)) {
      ...
      if (status === STATUS.FINISHED) {
        ...
        localStorage.setItem('dashboardTourCompletedAt', new Date().toISOString())
      }
