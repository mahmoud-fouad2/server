          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <img 
                ...
                onError={(e) => {
                  e.target.src = "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&q=80&w=1200"
                }}
              />
            </motion.div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: 'ولي أمر يسأل',
                  scenario: 'ولي أمر يرسل "عايز أسجل ابني في دورة إنجليزي" - البوت يعرض الدورات المتاحة، المواعيد، والأسعار ويسجله فوراً'
                },
                {
                  title: 'طالب يستفسر',
                  scenario: 'طالب يسأل "امتى موعد الامتحان؟" - البوت يرسل جدول الامتحانات الكامل وتفاصيل كل مادة'
                },
                {
                  title: 'إشعار غياب',
                  scenario: 'عند غياب طالب، البوت يرسل تلقائياً إشعاراً لولي الأمر مع تاريخ ووقت الغياب'
                }
              ].map((useCase, i) => (
                <motion.div
                  key={i}
