        ...
        <div className="grid gap-6">
          <Card>
            ...
            <CardContent>
              ...
              {message && (
                <div
                  className={`mt-4 p-4 rounded-lg flex items-center gap-2 ${message.includes('نجاح') ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'}`}
                >
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground text-sm">
                قائمة الملفات التي تم تدريب البوت عليها ستظهر هنا قريباً.
              </p>
            </CardContent>
          </Card>
        </div>
