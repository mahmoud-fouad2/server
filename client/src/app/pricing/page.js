        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-10">
              جميع الباقات تشمل تجربة مجانية لمدة 7 أيام - لا حاجة لبطاقة ائتمانية
            </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">الباقة الأساسية</h3>
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-gray-900 dark:text-white">
                    {billingCycle === 'yearly' 
                      ? Math.round(pricing.starter.price.replace(',', '') * 0.8) 
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-gray-900 dark:text-white">
                    {billingCycle === 'yearly' 
                      ? Math.round(pricing.agency.price.replace(',', '') * 0.8) 
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                  <Check size={18} className="text-green-500" /> مدير حساب مخصص
                </li>
                <li className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-white/10">
                  <th className="text-right py-4 px-6 text-gray-600 dark:text-gray-400 font-medium">الميزة</th>
                  <th className="text-center py-4 px-6 text-gray-900 dark:text-white font-bold">أساسية</th>
                  <th className="text-center py-4 px-6 text-brand-600 dark:text-brand-400 font-bold">احترافية</th>
                  <th className="text-center py-4 px-6 text-gray-900 dark:text-white font-bold">وكالات</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  { feature: 'مدير حساب', starter: false, pro: false, agency: true },
                  { feature: 'دعم فني', starter: 'Email', pro: 'أولوية', agency: '24/7' }
                ].map((row, i) => (
                  <tr key={i} className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5">
                    ...
                    <td className="text-center py-4 px-6 text-gray-600 dark:text-gray-400">
                      {typeof row.starter === 'boolean' 
                        ? (row.starter ? <Check size={20} className="text-green-500 inline" /> : <X size={20} className="text-gray-400 inline" />)
                        : row.starter}
                    </td>
                    <td className="text-center py-4 px-6 text-gray-900 dark:text-white font-medium">
                      {typeof row.pro === 'boolean' 
                        ? (row.pro ? <Check size={20} className="text-green-500 inline" /> : <X size={20} className="text-gray-400 inline" />)
                        : row.pro}
                    </td>
                    <td className="text-center py-4 px-6 text-gray-600 dark:text-gray-400">
                      {typeof row.agency === 'boolean' 
                        ? (row.agency ? <Check size={20} className="text-green-500 inline" /> : <X size={20} className="text-gray-400 inline" />)
                        : row.agency}
                    </td>
                  </tr>
                ))}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">{item.q}</h3>
