...
export const DemoChatWindow = () => {
  return (
    <div className="w-full max-w-3xl mx-auto font-sans relative group" dir="rtl">
      {/* Glow Effect */}
        ...
        <div className="bg-gray-100/50 dark:bg-cosmic-950 p-6 min-h-[400px] flex flex-col gap-6 relative overflow-hidden">
          ...
          <div className="flex gap-4 items-start relative z-10 animate-fade-in-up">
            ...
            <div className="bg-white dark:bg-cosmic-800 text-gray-800 dark:text-gray-100 p-4 rounded-2xl rounded-tr-none max-w-[85%] leading-relaxed shadow-sm border border-gray-200 dark:border-white/5">
              <p className="font-bold text-brand-600 dark:text-brand-400 text-xs mb-1">المساعد الذكي</p>
              أهلاً بك! 👋 أنا فهملي، مساعدك الذكي. قرأت المنيو بالكامل وأنا جاهز لاستقبال طلبات زبائنك. كيف أقدر أساعدك اليوم؟
            </div>
          </div>

          {/* User Message */}
          <div className="flex gap-4 items-start flex-row-reverse relative z-10 animate-fade-in-up" style={{animationDelay: '1s'}}>
            <div className="w-10 h-10 rounded-full bg-gray-200 dark:bg-cosmic-700 flex items-center justify-center flex-shrink-0 border-2 border-white dark:border-cosmic-600 shadow-sm">
               <span className="text-sm font-bold text-gray-600 dark:text-gray-300">أنت</span>
            </div>
          ...
          {/* Bot Reply (Simulated) */}
          <div className="flex gap-4 items-start relative z-10 animate-fade-in-up" style={{animationDelay: '2.5s'}}>
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-brand-600 to-indigo-700 p-[1px] flex items-center justify-center flex-shrink-0 shadow-lg shadow-brand-500/20">
               <div className="w-full h-full bg-white dark:bg-cosmic-800 rounded-[14px] flex items-center justify-center overflow-hidden">
                  <img src="/logo2.png" alt="Faheemly AI" className="w-full h-full object-contain" />
               </div>
            </div>
            <div className="bg-white dark:bg-cosmic-800 text-gray-800 dark:text-gray-100 p-4 rounded-2xl rounded-tr-none max-w-[85%] leading-relaxed shadow-sm border border-gray-200 dark:border-white/5">
              <p className="font-bold text-brand-600 dark:text-brand-400 text-xs mb-1">المساعد الذكي</p>
              ...
              <ul className="mt-2 space-y-1 text-sm">
                <li className="flex items-center gap-2"><span className="text-green-500">✓</span> سلطة الكينوا مع الأفوكادو</li>
                <li className="flex items-center gap-2"><span className="text-green-500">✓</span> برجر نباتي (Beyond Meat)</li>
                <li className="flex items-center gap-2"><span className="text-green-500">✓</span> باستا الخضروات المشوية</li>
              </ul>
              <div className="mt-3 pt-3 border-t border-gray-100 dark:border-white/5 flex gap-2">
                 <button className="text-xs bg-brand-50 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 px-3 py-1.5 rounded-full hover:bg-brand-100 dark:hover:bg-brand-900/50 transition-colors">اطلب الآن</button>
                 <button className="text-xs bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-400 px-3 py-1.5 rounded-full hover:bg-gray-200 dark:hover:bg-white/10 transition-colors">عرض الصور</button>
              </div>
            </div>
          </div>

          {/* Typing Indicator */}
          <div className="flex gap-4 items-end mt-auto animate-fade-in" style={{animationDelay: '4s'}}>
             <div className="w-8 h-8 rounded-xl bg-white dark:bg-cosmic-800 flex items-center justify-center flex-shrink-0 opacity-50 overflow-hidden">
                <img src="/logo2.png" alt="AI" className="w-full h-full object-contain grayscale" />
            </div>
        ...
        <div className="bg-white dark:bg-cosmic-900 p-4 border-t border-gray-200 dark:border-white/5">
          <div className="bg-gray-50 dark:bg-cosmic-800 rounded-full p-2 pl-4 flex items-center gap-3 border border-gray-200 dark:border-white/5 focus-within:ring-2 focus-within:ring-brand-500/20 transition-all">
            ...
            <div className="flex items-center gap-1 pr-2 border-r border-gray-200 dark:border-white/10 mr-2">
               <button className="p-2 text-gray-400 hover:text-brand-500 transition-colors"><Mic size={18} /></button>
               <button className="p-2 text-gray-400 hover:text-brand-500 transition-colors"><Paperclip size={18} /></button>
            </div>
          </div>
        </div>
      </div>
