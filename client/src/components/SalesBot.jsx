...
const SalesBot = ({ lang = 'ar' }) => {
  ...
  const hiddenPaths = ['/dashboard', '/admin', '/login', '/register', '/wizard'];
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Messages */}
            <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-sm" ref={scrollRef}>
              {messages.map((m, i) => (
                <motion.div 
