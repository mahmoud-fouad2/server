...
export default function SEOHead({ 
  ...
  const title = customTitle || seoData?.title || `${APP_NAME} - الموظف الذي لا ينام`
  const description = customDesc || seoData?.desc || 'أقوى شات بوت عربي ذكي للمطاعم والمتاجر والعيادات'
  const keywords = customKeywords || seoData?.keywords || 'شات بوت عربي, ذكاء اصطناعي, واتساب'
