      ...
      <div className="min-h-screen bg-gray-50 dark:bg-cosmic-950" dir="rtl">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed">
                حوّل واتساب إلى متجر إلكتروني كامل المميزات
              </p>
              <div className="flex gap-4 justify-center">
                <Link href="/register">
                  <Button className="h-14 px-10 text-lg rounded-full shadow-xl bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: <Package />,
                number: '24/7',
                label: 'خدمة مبيعات متواصلة',
              },
              {
                icon: <CreditCard />,
                number: '40%',
                label: 'زيادة متوسط السلة',
              },
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-purple-500/10 flex items-center justify-center mx-auto mb-4 text-purple-500">
                  {stat.icon}
                </div>
              ...
              {[
                {
                  ...
                  desc: 'عرض منتجاتك بالصور والأسعار والتفاصيل الكاملة',
                },
                {
                  title: 'إتمام عمليات الشراء',
                  desc: 'سلة تسوق ذكية مع حساب تلقائي للمبلغ والشحن',
                },
                {
                  title: 'تتبع الشحنات',
                  desc: 'إرسال تحديثات فورية عن حالة الطلب والشحن',
                },
                {
                  title: 'توصيات ذكية',
                  desc: 'اقتراح منتجات بناءً على اهتمامات العميل',
                },
              ].map((feature, i) => (
                <motion.div
                  key={i}
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/register">
              <Button className="h-16 px-12 text-xl font-bold rounded-full shadow-2xl bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600">
