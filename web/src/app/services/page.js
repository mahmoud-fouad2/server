...
const services = [
  {
    ...
    description:
      'اربط رقمك التجاري بمنصة فهملي، وسيقوم البوت بالرد على استفسارات العملاء، أخذ الطلبات، وحجز المواعيد تلقائياً 24/7.',
    color: 'green',
    features: [
  ...
  },
  {
    ...
    description:
      'اربط حسابك على تيليجرام واستقبل الرسائل تلقائياً. نفس ذكاء واتساب مع ملايين المستخدمين.',
    color: 'purple',
    features: [
  ...
  },
  {
    ...
    description:
      'احصل على رؤى قيمة عن محادثات عملائك. تقارير مفصلة عن الأسئلة الأكثر شيوعاً، أوقات الذروة، ومعدلات الرضا.',
    color: 'indigo',
    features: [
      'تقارير يومية وشهرية',
  ...
  },
  {
    ...
    description:
      'تقنية AI حديثة تفهم السياق والنية. تعلم مستمر من كل محادثة لتحسين الأداء.',
    color: 'red',
    features: [
      'فهم عميق للسياق',
      'تعلم آلي مستمر',
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-16 h-16 rounded-2xl bg-${service.color}-500/10 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 text-${service.color}-500`}
                    >
                      {service.icon}
                    </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact">
                <Button
                  variant="outline"
                  className="h-14 px-8 text-xl rounded-full border-gray-300 dark:border-white/10"
                >
