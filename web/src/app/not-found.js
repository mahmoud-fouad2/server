...
export default function NotFound() {
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center bg-[#f4f6f8] dark:bg-cosmic-950 text-center p-4"
      dir="rtl"
    >
      ...
      <h1 className="text-9xl font-black text-brand-500/20 mb-4 select-none">
        404
      </h1>
      ...
      <p className="text-gray-600 dark:text-gray-400 max-w-md mb-8 text-lg">
        يبدو أنك ضللت الطريق. لا تقلق، فهملي هنا لإرشادك للعودة إلى المسار
        الصحيح.
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Link href="/contact">
          <Button
            variant="outline"
            className="h-12 px-8 text-lg rounded-xl gap-2 border-gray-300 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/5"
          >
