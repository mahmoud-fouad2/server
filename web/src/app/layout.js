...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'حول زوار موقعك إلى عملاء دائمين مع فهملي. شات بوت ذكي يفهم اللهجات العربية من الخليج إلى المغرب ويدير أعمالك 24/7. ابدأ الآن بـ199 ريال فقط.',
...
export default function RootLayout({ children }) {
  return (
    <html lang="ar" dir="rtl" suppressHydrationWarning>
      <head>
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self' https://fahimo-api.onrender.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fahimo-api.onrender.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data:; connect-src 'self' https://fahimo-api.onrender.com wss://fahimo-api.onrender.com; media-src 'self' https://assets.mixkit.co;" />
